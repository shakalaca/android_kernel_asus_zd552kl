...
//<ASUS-BSP Robert_He 20170508> diable capsensor when touch pressed and disable fp when press two key++++++
#ifdef ZD552KL_PHOENIX
extern bool press_touch;
extern bool disable_cap_off;
...
//<ASUS-BSP Robert_He 20170405> add capsensor vkled function ------				
				...
				{	
					...
					{
//<ASUS-BSP Robert_He 20170426> add capsensor press log ++++++
#ifdef ZD552KL_PHOENIX
						if (press_touch)
						{
							printk("[FTS_CAP]disable BACK for touch press\n");
							return;
						}
						if (disable_cap_off)
						{
							printk("[FTS_CAP]disable capsensor for panel off\n");
							return;
						}
						if (g_FP_Disable_Touch)
						{
							printk("[FTS_CAP]disable capsensor for fingerprint\n");
							return;
						}
					    printk("[FTS_CAP] BACK key pressed!\n");
#endif
//<ASUS-BSP Robert_He 20170426> add capsensor press log ------
...
//<ASUS-BSP Robert_He 20170508> diable capsensor when touch pressed and disable fp when press two key++++++
							...
							if (press_touch)
							{
								printk("[FTS_CAP]disable MENU for touch press\n");
								return;
							}
...
//<ASUS-BSP Robert_He 20170508> diable capsensor when touch pressed and disable fp when press two key++++++
							...
							//<ASUS-BSP Robert_He 20170426> add capsensor press log ++++++
#ifdef ZD552KL_PHOENIX
							printk("[FTS_CAP] MENU key pressed!\n");
#endif
							//<ASUS-BSP Robert_He 20170426> add capsensor press log ------
...
//<ASUS-BSP Robert_He 20170505> add esd check suspend/resume logic ++++++
	...
	if (ESD_SUSPEND_CAP)
    {
    	dev_info(dev, "ESD check fail,should not suspend\n");
		return 0;
    }
#endif
//<ASUS-BSP Robert_He 20170505> add esd check suspend/resume logic ------
...
//<ASUS-BSP Robert_He 20170505> add esd check suspend/resume logic ++++++
	...
	if (ESD_SUSPEND_CAP)
    {
    	dev_info(dev, "ESD check fail,should not resume\n");
		ESD_SUSPEND_CAP = false;
		return 0;
    }
#endif
//<ASUS-BSP Robert_He 20170505> add esd check suspend/resume logic ------
